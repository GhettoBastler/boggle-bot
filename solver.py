...
def get_parser():
    ...
    parser.add_argument('-d', '--delay', type=float, default=1, help='How long to wait before showing the next solution in auto mode (in seconds)')
...
def main():
    ...
    print(f'Found {len(paths)} words in {time.time()-t_start:.3f} seconds.')
